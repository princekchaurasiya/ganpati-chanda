...
ExpenseCategory = Literal["Materials", "Food", "Decoration", "Rent", "Utilities", "Transport", "Mandap", "Murti", "Murti Dye", "Banner", "Police & BMC", "Documents", "Dahi Handi", "Aarti Samagri", "Band Baja", "Other"]
...
async def build_member_summaries(year: Optional[str] = None):
    ...
    for name in sorted(names):
        ...
        # Pocket = group cash in hand − unreimbursed personal.
        # Reimburse out bhi minus: Sujit ka ₹555 aaya to Sonu ko ₹550 diya — dono count.
        net_position = (
            total_received - transferred_out + transferred_in
            - (group_funds_paid + personal_contribution)
            + reimbursement_received
            - reimbursement_paid_out
        )
